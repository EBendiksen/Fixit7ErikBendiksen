...
const cacheName = 'fixit7DerekRichard-2020-10-04 20:22:26.930345'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'fixit7DerekRichard'.length) === 'fixit7DerekRichard') {
